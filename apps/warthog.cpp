...
void
run_experiments(Search& algo, std::string alg_name,
...
void
run_astar(warthog::util::scenario_manager& scenmgr, std::string mapname, std::string alg_name)
{
	...
	warthog::search::unidirectional_search<
		warthog::heuristic::octile_heuristic,
	   	warthog::search::gridmap_expansion_policy, 
        warthog::util::pqueue_min> 
...
void
run_astar4c(warthog::util::scenario_manager& scenmgr, std::string mapname, std::string alg_name)
{
    warthog::domain::gridmap map(mapname.c_str());
	warthog::search::gridmap_expansion_policy expander(&map, true);
	warthog::heuristic::manhattan_heuristic heuristic(map.width(), map.height());
    warthog::util::pqueue_min open;

	warthog::search::unidirectional_search<
		warthog::heuristic::manhattan_heuristic,
	   	warthog::search::gridmap_expansion_policy, 
        warthog::util::pqueue_min> 
            astar(&heuristic, &expander, &open);
...
void
run_dijkstra(warthog::util::scenario_manager& scenmgr, std::string mapname, std::string alg_name)
{
    warthog::domain::gridmap map(mapname.c_str());
	warthog::search::gridmap_expansion_policy expander(&map);
	...
	warthog::search::unidirectional_search<
		warthog::heuristic::zero_heuristic,
	   	warthog::search::gridmap_expansion_policy,
        warthog::util::pqueue_min> 
            astar(&heuristic, &expander, &open);
...
void
run_wgm_astar(warthog::util::scenario_manager& scenmgr, std::string mapname, std::string alg_name, std::string costfile)
{
